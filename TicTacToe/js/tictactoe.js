...
let activePlayer='X';
//This array stores moves, and determins win conditions.
let selectedSquares=[];

//This function is for preparing an x or o in a square.
...
//drawWinLine function is called to draw line if if condition is met.
function checkWinConditions() {
    ...
    //squares are selected the code executes.
        ...
        audio('./media/tie.mp3');
        //This function sets a .3 sec timer before the reset game is called.
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        //These 3 variables will be used to check for 3 boxes in a row.
...
//This function takes a string perameter of the path set earlier for placement sound.
...
//This line accesses our html canvas element.
    ...
    //This line gives us access to methods and propertys to use on canvas.
    ...
    function animateLineDrawing() {
        ...
        if (x1 <= x2 && y1 <= y2) {
            ...
            if (y < y2) {y += 10; }
            //This condition cancels out our animation loop
